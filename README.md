...
To begin, one of the reasons why I discovered myself was due to Competitive Programming, it's a way to challenge myself every moment. Furthermore I really like to make robots (since 2020, when I developed a simple robotic claw), code and enhance them, so if you want to see all projects which I developed, access: <a href="https://github.com/NicolasAuersvalt/projects/tree/main/cpp">Robotics</a>;<br>
