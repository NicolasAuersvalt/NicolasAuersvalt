...
To begin, one of the reasons why I discovered myself was Competitive Programming, it's a way to challenge myself every moment. I really like to make robots, code and enhance them, so if you want to see all projects which I developed, please acess: https://github.com/NicolasAuersvalt/projects/tree/main/cpp;
If you want to see Arboretum Project, acess: https://github.com/NicolasAuersvalt/UTFPR/tree/main/Lab_Eletr%C3%B4nica/Arboretum
